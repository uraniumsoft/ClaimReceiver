...
class DataContentAddWidget extends StatefulWidget {
  const DataContentAddWidget({Key? key}) : super(key: key);

  @override
  _DataContentAddWidgetState createState() => _DataContentAddWidgetState();
}
...
class _DataContentAddWidgetState extends State<DataContentAddWidget> {
  ...
  void initState() {
    super.initState();
    textContentNameController = TextEditingController();
    textContentPriceController = TextEditingController();
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  setState(() => FFAppState().PriceNumber =
                                      double.parse(
                                          textContentPriceController!.text));
