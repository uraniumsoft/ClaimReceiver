...
class DataUnitAddWidget extends StatefulWidget {
  const DataUnitAddWidget({
    Key? key,
    this.roomRef,
  }) : super(key: key);
  ...
  @override
  _DataUnitAddWidgetState createState() => _DataUnitAddWidgetState();
}

class _DataUnitAddWidgetState extends State<DataUnitAddWidget> {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  final unitsCreateData = createUnitsRecordData(
                                    unitName: textUnitNameController!.text,
                                  );
                                  await UnitsRecord.collection
                                      .doc()
                                      .set(unitsCreateData);
                                  context.pop();
                                },
